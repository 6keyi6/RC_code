...
//TxMessage_text.StdId= CAN_Tx_Msg ;	// 标准标识符 
//TxMessage_text.ExtId= 0;			    // 设置扩展标示符 
//TxMessage_text.IDE=CAN_Id_Standard; 	// 标准帧
//TxMessage_text.RTR=CAN_RTR_Data;		// 数据帧
//TxMessage_text.DLC=8;				// 要发送的数据长度
