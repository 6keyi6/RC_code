...
{
    *Voltage = Voltage_a * (INA226_GetVoltage(INA226_ADDR1)*Voltage_LSB) + Voltage_k;
}
...
{
    *Power = Power_a * (INA226_Get_Power(INA226_ADDR1)*POWER_LSB) + Power_k;
}
...
{
    *Current = Current_a * ((INA226_GetShunt_Current(INA226_ADDR1)* CURRENT_LSB)) + Current_k;
}
