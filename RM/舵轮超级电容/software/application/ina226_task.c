...
//	tx_data_16[0] = ina226_data.Power;			//功率mW
//	tx_data_16[1] = ina226_data.voltageVal;	//mV
//	tx_data_16[2] = ina226_data.Shunt_Current;	//mA
//	tx_data_16[3] = ina226_data.Shunt_voltage;	//uV
//	can_send_msg(tx_data_16[0],tx_data_16[1],tx_data_16[2],tx_data_16[3]);
}

void ina226_can_send_32(void)
{
//	u32 tx_data[4];
//	tx_data[0] = ina226_data.Power;			//功率mW
//	tx_data[1] = ina226_data.voltageVal;	//mV\mA\uV\W
//	tx_data[2] = ina226_data.Shunt_Current;	//mA
//	tx_data[3] = ina226_data.Shunt_voltage;	//uV
//	can_send_msg_32(tx_data[0],tx_data[1],tx_data[2],tx_data[3]);
	sdd.Shunt_Current = ina226_data.Shunt_Current;	//mA
	sdd.voltageVal = ina226_data.voltageVal;	//mV
	can_send_msg_sd();
}
