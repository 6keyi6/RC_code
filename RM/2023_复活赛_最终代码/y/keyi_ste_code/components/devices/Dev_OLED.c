...
{
    static char *visionmode_str = "Vision_Forcast";
    ...
    case 0: 
        //--- 设备异常信息显示
        oled_showstring(0, 1, (uint8_t *)"Error Messages:");

        if(DevicesGet_State(VISION_MONITOR) == Off_line)
        {
            oled_showstring(1, 1, (uint8_t *)"Vision");
        }
        if(DevicesGet_State(COMMU_0X341_MONITOR)==Off_line/*  || DevicesMonitor.Get_State(COMMU_0X342_MONITOR)==Off_line */)
        {
            oled_showstring(1, 12, (uint8_t *)"CHAS CAN");
        }

        if(DevicesGet_State(GIMBAL_YAW_MONITOR) == Off_line)
        {
            oled_showstring(2,1,(uint8_t *)"Yaw Motor");
        }
        if(DevicesGet_State(GIMBAL_PIT_MONITOR) == Off_line)
        {
            oled_showstring(2,12,(uint8_t *)"Pit Motor");
        }

        if(DevicesGet_State(FRIC_L_MONITOR) == Off_line)
        {
            oled_showstring(3, 1, (uint8_t *)"FricL");
        }
        if(DevicesGet_State(FRIC_R_MONITOR) == Off_line)
        {
            oled_showstring(3, 7, (uint8_t *)"FricR");
        }
        if(DevicesGet_State(RELOAD_MONITOR) == Off_line)
        {
            oled_showstring(3, 13, (uint8_t *)"Reloader");
        }

        if(DevicesGet_State(CAN1_MONITOR) == Off_line)
        {
            oled_showstring(4, 1, (uint8_t *)"CAN1");
        }
        if(DevicesGet_State(CAN2_MONITOR) == Off_line)
        {
            oled_showstring(4, 7, (uint8_t *)"CAN2");
        }
        if(DevicesGet_State(DR16_MONITOR) == Off_line)
        {
            oled_showstring(4, 13, (uint8_t *)"DR16");
        }
    ...
    case 1:
        //--- 云台相关数据
//        oled_showstring(0, 1, (uint8_t *)"Gimbal Message:");
//        oled_showstring(1, 1, (uint8_t *)"Yaw Encoder:");
//        oled_shownum(1, 14, Gimbal.Motor[Yaw].get_totalencoder(), 0, 5);
//        oled_showstring(2, 1, (uint8_t *)"Pit Encoder:");
//        oled_shownum(2, 14, Gimbal.Motor[Pit].get_totalencoder(), 0, 5);
//        oled_showstring(3, 1, (uint8_t *)"Yaw IMU:");
//        oled_shownum(3, 10, Gimbal.Get_IMUAngle(Yaw), 0, 3);
//        oled_showstring(4, 1, (uint8_t *)"Pit IMU:");
//        oled_shownum(4, 10, Gimbal.Get_IMUAngle(Rol), 0, 3);

        break;
    case 2:
        //--- 发射相关数据
//        oled_showstring(0, 1, (uint8_t *)"Shoot Massage:");
//        oled_showstring(1, 1, (uint8_t *)"Fric_L:");
//        oled_shownum(1, 10, Shoot.Fric_Motor[Fric_L].getSpeed(), 0, 4);
//        oled_showstring(2, 1, (uint8_t *)"Fric_R:");
//        oled_shownum(2, 10, Shoot.Fric_Motor[Fric_R].getSpeed(), 0, 4);
//        oled_showstring(3, 1, (uint8_t *)"Reloadre:");
//        oled_shownum(3, 10, Shoot.Reload_Motor.getSpeed(), 0, 5);
    ...
    case 3:
        ...
        {
        case Vision_Forcast:
            visionmode_str = "Forcast";
            break;
        
        case Vision_BIGWindmill:
            visionmode_str = "BIGWindmill";
            break;
        ...
        case Vision_Default:
            visionmode_str = "Default";
            break;

        case Vision_Disable:
            visionmode_str = "Disable";
            break;
        }
//        //--- 视觉相关数据
//        oled_showstring(0, 1, (uint8_t *)"Vision Massage:");
//        // oled_showstring(1, 1, Vision.Get_Mode()==true?(uint8_t *)"Armor: Yes!":(uint8_t *)"Armor: None!");
//        oled_showstring(1, 1, DevicesMonitor.Get_State(VISION_MONITOR)==Off_line?(uint8_t *)"Off Line!!!":(uint8_t *)visionmode_str);

//        oled_showstring(2, 1, (uint8_t *)"Yaw:");
//        oled_shownum(2, 4, Vision.Get_YawOffset(), 0, 3);
//        oled_showstring(3, 1, (uint8_t *)"Pit:");
//        oled_shownum(3, 4, Vision.Get_PitOffset(), 0, 3);
//        oled_showstring(4, 1, (uint8_t *)"Depth:");
//        oled_shownum(4, 5, Vision.Get_DepthOffset(), 0, 4);

        break;

    case 4:
        oled_showstring(0, 1, (uint8_t *)"Error Messages2:");

//        //--- 驱动轮
//        if(Infantry.Write_Msg[0][0] == Off_line)
//        {
//            oled_showstring(1, 1, (uint8_t *)"DRV_0");
//        }
//        if(Infantry.Write_Msg[0][1] == Off_line)
//        {
//            oled_showstring(1, 6, (uint8_t *)"DRV_1");
//        }
//        if(Infantry.Write_Msg[0][2] == Off_line)
//        {
//            oled_showstring(1, 11, (uint8_t *)"DRV_2");
//        }
//        if(Infantry.Write_Msg[0][3] == Off_line)
//        {
//            oled_showstring(1, 16, (uint8_t *)"DRV_3");
//        }
//        //--- 转向轮
//        if(Infantry.Write_Msg[0][4] == Off_line)
//        {
//            oled_showstring(2, 1, (uint8_t *)"RUD_0");
//        }
//        if(Infantry.Write_Msg[0][5] == Off_line)
//        {
//            oled_showstring(2, 6, (uint8_t *)"RUD_1");
//        }
//        if(Infantry.Write_Msg[0][6] == Off_line)
//        {
//            oled_showstring(2, 11, (uint8_t *)"RUD_2");
//        }
//        if(Infantry.Write_Msg[0][7] == Off_line)
//        {
//            oled_showstring(2, 16, (uint8_t *)"RUD_3");
//        }

//        if(Infantry.Write_Msg[1][0] == Off_line)
//        {
//            oled_showstring(2, 1, (uint8_t *)"Commu");
//        }

//        if(Infantry.Write_Msg[1][1] == Off_line)
//        {
//            oled_showstring(3, 1, (uint8_t *)"Referee");
//        }

//        if(Infantry.Write_Msg[1][2] == Off_line)
//        {
//            oled_showstring(4, 1, (uint8_t *)"SupCap");
//        }
//        if(Infantry.Write_Msg[1][3] == Off_line)
//        {
//            oled_showstring(4, 10, (uint8_t *)"PowerMeter");
//        }
    ...
    case 5:
        //--- 默认界面 显示logo
        RM_LOGO();
        OLED_ShowChinese(20, 48, Keyi_Infantry_1, 16);
        OLED_ShowChinese(45, 48, Keyi_Infantry_2, 16);
        OLED_ShowChinese(70, 48, Keyi_Infantry_3, 16);
        OLED_ShowChinese(95, 48, Keyi_Infantry_4, 16);
