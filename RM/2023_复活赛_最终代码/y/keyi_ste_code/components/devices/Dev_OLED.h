...
#define OLED_SCLK_Clr()     HAL_GPIO_WritePin(OLED_SCK_GPIO_Port, OLED_SCLK_Pin, GPIO_PIN_SET)
#define OLED_SCLK_Set()     HAL_GPIO_WritePin(OLED_SCK_GPIO_Port, OLED_SCLK_Pin, GPIO_PIN_RESET)
