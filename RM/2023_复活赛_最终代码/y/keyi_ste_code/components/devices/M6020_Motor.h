...
extern positionpid_t M6020_Yaw_OUT;//YAW轴PID参数
extern positionpid_t M6020_Yaw_IN;//YAW轴PID参数

extern positionpid_t M6020_PIT_OUT;//YAW轴PID参数
extern positionpid_t M6020_PIT_IN;//YAW轴PID参数
